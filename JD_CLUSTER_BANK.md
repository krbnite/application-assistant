...
| Cleerly | Health, Wearables, Neurotech, And Digital Biomarkers | None | Medium-High | Medical-device image processing (coronary CT angiography) role; imaging modality differs from Kevin's wearable-sensing spine but the clinical-rigor/validation/regulated-product core matches the cluster directly. |
| Abridge - Senior Research Data Scientist | Quantitative Research ML Engineering | Health, Wearables, Neurotech, And Digital Biomarkers | High | Research-team data-infrastructure/applied-science hybrid role for a healthcare-AI product; core ask (pipelines, causal/descriptive analysis, evaluation-framework rigor, mathematical maturity) matches QRE directly; health domain and mission language borrowed from HWD. |
| Abridge - Research Scientist (Measurement and Evaluation) | Measurement Science, Evaluation, And Causal Inference | Health, Wearables, Neurotech, And Digital Biomarkers | Low | New provisional cluster; role asks for independent causal/quasi-experimental study leadership, a named quantitative/social-science PhD field, and an evaluation-science publication track record that Kevin's evidence only partially supports. Applied as a deliberate stretch, not a strong-fit application. |
...
- 2026-08-26: Added Cleerly Senior ML Scientist JD to the Health, Wearables, Neurotech, And Digital Biomarkers archetype. Decision: no new cluster; Cleerly is medical-device image processing (coronary CT angiography) rather than wearables, but shares the same clinical-rigor, validation, and research-to-product-translation core as the rest of the cluster. Adds reusable signal around coronary/cardiac and CT/MRI imaging, medical-imaging segmentation/registration/reconstruction/detection, a top-tier medical-imaging/computer-vision publication track record (MICCAI, IEEE TMI, CVPR, Medical Image Analysis, MIDL), patent authorship, and managing research collaborations with academic/medical institutions. Also adds a paired do-not-overstate note since Kevin's own publication record (Sensors, working papers, a conference poster) does not itself clear that top-tier medical-imaging bar.
- 2026-08-26: Added Abridge Senior Research Data Scientist JD to the Quantitative Research ML Engineering archetype. Decision: no new cluster; this is the second QRE-cluster source JD and confirms the cluster generalizes beyond quant finance to any research-intensive organization that needs a scientist who bridges data infrastructure and rigorous applied analysis. Adds reusable signal around causal and descriptive analysis of observational data, construct validity, measurement-error characterization, selection-bias auditing, owning data provenance/structure/limitations for a research team, and translating analyses for non-technical/commercial stakeholders.
- 2026-08-26: Added Abridge Research Scientist (Measurement and Evaluation) JD as a new provisional cluster, `Measurement Science, Evaluation, And Causal Inference`. Decision: new cluster needed; none of the existing archetypes center on independently designing and leading causal/quasi-experimental evaluation studies, and this JD names a specific quantitative/social-science PhD field and an evaluation-science-specific publication bar that no existing cluster's do-not-overstate language covers. Applied to Kevin's real measurement/verification-adjacent evidence (CVB sleep-measurement validity reframing, sensor-driven proxy-measurement framework design, deployment-honest validation) as a deliberate stretch application, with an explicit Low confidence rating and paired gap notes (PhD field, no formal causal-inference methods training, no evaluation-science-venue publication).
- 2026-08-27: Added Oracle OCI Senior Principal Applied Scientist JD to the Quantitative Research ML Engineering archetype. Decision: no new cluster yet; QRE is still the closest fit because the role centers on scientific-data workflows, model/platform evaluation, research-to-production leadership, data/ML/AI integration, and reusable platform capability rather than direct molecular-biology or bioinformatics research. Emerging signal to watch: if 2-3 more JDs center on strategic-customer scientific workflow discovery, GenAI/RAG/agents or knowledge systems, rigorous evaluation harnesses, and reusable enterprise AI platform capabilities, consider creating a distinct `Applied Science Platform Leadership` or `Scientific AI Platform Leadership` cluster.

## Cluster Archetype JD Template

- 2026-08-27: Added RTX / FlightAware Senior Machine Learning Engineer II JD to the Industrial And Operational Time-Series ML archetype. Decision: no new cluster; the role centers on live operational prediction and productized forecasts, while adding reusable signal around aviation/transportation operations, runway/gate/taxi timing prediction, weather/geospatial context, image/video data as complex-data add-ons, performance efficiency, observability/orchestration tooling, and hybrid cloud/on-prem infrastructure.
...
| Industrial And Operational Time-Series ML | Updated 2026-08-27 | Oden Technologies, Cutsforth, Cargill, RTX / FlightAware, with Lumicity as a health/regulated-product bridge. |
...
- Source JDs used: Voleon Senior Machine Learning Engineer, Abridge Senior Research Data Scientist, Oracle OCI Senior Principal Applied Scientist.
- Archetype role title(s): Senior Machine Learning Engineer, Research ML Engineer, Quantitative Research Engineer, ML Infrastructure Engineer for Research Teams, Applied ML Engineer, Senior Research Data Scientist, Senior/Principal Applied Scientist.
- Typical company / product context: quantitative investment management, research-intensive AI/ML organizations (including health-AI and other applied-research startups, not only finance), scientific or statistical modeling teams, productized research environments, scientific AI platform teams, and teams where PhD researchers or domain experts need maintainable model, data, and experimentation systems.
...
- Variable / add-on signals: quantitative trading, financial time series, alpha research, model-development frameworks, experiment management, ML workflow orchestration, distributed computing, model serving, feature stores, performance profiling, numerical-code optimization, R, C/C++, Linux, production ownership for research systems, causal and descriptive analysis of observational data, construct validity and measurement-error characterization, selection-bias auditing in observational/feedback signals, being a team's resident authority on data provenance/structure/limitations, GenAI/RAG/agents or knowledge systems for scientific workflows, strategic-customer workflow discovery, reusable enterprise AI platform capability, and translating complex analyses into decision-relevant narratives for non-technical/commercial stakeholders.
- Typical responsibilities: partner with researchers to design, implement, and productize ML/statistical models; build and maintain data pipelines; develop feature engineering, validation, quality-monitoring, and model-evaluation infrastructure; translate prototypes into performant, well-tested, maintainable code; debug subtle data-quality issues; lead projects from requirements through delivery; set engineering standards inside research teams; operate flexibly across data engineering, data analysis, and applied science so a research team can move from raw data to credible insight.
- Typical requirements: Python, NumPy, Pandas, SciPy, scikit-learn, PyTorch/TensorFlow or similar; Linux; software-engineering fundamentals; data structures, algorithms, systems design; statistics, probability, optimization, linear algebra; data-quality discipline; reproducibility; clear communication with researchers and non-technical stakeholders; often R, C/C++, distributed computing, model serving, feature stores, experiment management, performance profiling, or code-based data visualization (Matplotlib/Seaborn/ggplot2).
- Common keywords and phrases: quantitative research, research engineering, production-quality code, production-ready models, data ingestion, feature engineering, validation, quality monitoring, model evaluation, experimentation lifecycle, ML workflow orchestration, model-development frameworks, numerical computing, statistical modeling, mathematical maturity, imperfect data, heterogeneous data, reproducibility, correctness, maintainability, performance profiling, financial time series, causal analysis, descriptive analysis, construct validity, measurement error, selection bias, data provenance, research-ready datasets.
- Hidden evaluation concerns: whether Kevin can transfer from sensor/health/geophysical ML to finance or another quantitative research domain; whether he has enough software-engineering depth for a senior MLE bar; whether distributed-computing, cloud-platform, model-serving, and performance-optimization gaps are handled honestly; whether his broad research background lands as mathematical/productive rather than diffuse; whether he can collaborate with PhD researchers and domain experts without over-indexing on domain narrative; whether he can credibly be "the data expert" (provenance, structure, limitations) for a research team rather than only a model builder; for scientific AI platform roles, whether practical agent/LLM workflow experience is framed as applied product/evaluation judgment rather than foundation-model research.
...
- Resume bullets usually retained: Podimetrics robust estimator validation, production scan-pipeline code/QC integration, and cross-functional translation; CVB deployment-honest validation, sleep-measurement validity reframing, large-scale data processing, database/schema evaluation, sensor-driven questionnaire/proxy-measurement estimation, reproducible workflows, and deep time-series/ablation work; WWE production customer/viewership data products; CSTR spectral/time-frequency methods, mathematical modeling, and geophysical signal interpretation; selected publications that signal mathematical and research credibility.
...
- Gaps / do-not-overstate items: do not claim direct quant-trading strategy ownership, financial-market modeling experience, hedge-fund infrastructure experience, large-scale distributed ML platform ownership, deep C++ systems/performance engineering, formal finance domain expertise, formal causal-inference/quasi-experimental methods training (e.g., instrumental variables, difference-in-differences, matching), direct molecular-biology/genomics/bioinformatics ownership, or OCI/enterprise cloud-platform ownership unless Kevin confirms it.
- Emerging cluster watch: Oracle-style Senior Principal Applied Scientist roles may justify a new `Applied Science Platform Leadership` / `Scientific AI Platform Leadership` cluster if several future JDs share the same core: strategic-customer scientific workflow discovery, GenAI/RAG/agents or knowledge systems, rigorous evaluation harnesses, and reusable enterprise platform capability. Until then, treat this as QRE with a platform/applied-science add-on.
...
- Typical company / product context: AI-product or health-AI companies that need an independent scientist to design and lead empirical (experimental or quasi-experimental) studies of an AI system's or intervention's real-world impact, usually in partnership with external institutions (health systems, academic/medical partners), and to publish that work externally.
- Core / necessary matching signals: the JD centers on independently designing and leading rigorous empirical studies (experimental or quasi-experimental) that evaluate an AI system's or intervention's real-world impact on outcomes; it asks for operationalizing hard-to-measure constructs (e.g., quality of care, safety, cognitive burden, ROI) via principled measurement frameworks; it expects a strong personal publication track record specifically in evaluation/measurement science, not just applied ML; it names a specific quantitative or social-science PhD field (statistics, biostatistics, economics, information systems, clinical informatics, or similar) rather than accepting any technical PhD.
- Variable / add-on signals: mentoring research interns, partner-facing (external health-system, academic, or customer) research relationships, close collaboration with science/product teams on core model evaluation, causal-inference-specific methods (quasi-experimental design, RCT-adjacent thinking, observational-data causal estimation), measurement-validity/verification methodology, construct operationalization, technical report writing and stakeholder presentations.
- Typical responsibilities: design and lead empirical/quasi-experimental studies; build measurement frameworks for constructs without an adequate direct instrument; validate model outputs or automated metrics against human judgment or ground truth; write technical reports and present to internal and external stakeholders; publish original research; mentor interns; inform model-development and product strategy from evaluation findings.
- Typical requirements: PhD in statistics, biostatistics, computer science, economics, information systems, clinical informatics, or a closely related field; rigorous quantitative or mixed-methods research training; a demonstrated publication record specifically in evaluation and measurement (not just applied ML or domain-science publications).
- Common keywords and phrases: measurement science, construct validity, quasi-experimental, causal inference, program evaluation, evaluation framework, empirical study, observational data, mixed methods, partner-facing research, operationalize, principled measurement framework, real-world impact.
- Hidden evaluation concerns: whether a candidate's PhD field and publication record clear the specific evaluation/measurement-science bar the JD names (a generic technical PhD and applied-ML publications are not obviously sufficient); whether the candidate can independently design and lead a causal or quasi-experimental study without formal causal-inference methods training; whether adjacent measurement/verification work (e.g., instrument-agreement methods, proxy-measurement frameworks for hard-to-observe constructs) reads as genuine evaluation-science depth or as applied-ML/signal-processing work wearing evaluation-science language.
- Tone and culture signals: startup pace combined with academic rigor; mission-driven; partner-facing and publication-facing; "problem-before-method" framed explicitly as a value (do not distort the question to fit a convenient method).
- Best starting profile: Measurement Science, Evaluation, And Causal Inference (Provisional).
- Resume bullets usually retained: CVB sleep-measurement validity reframing (instrument-agreement methodology), sensor-driven proxy-measurement framework design, research-strategy/feasibility judgment ("problem-before-method" evidence), clinician-facing interpretable ML, deployment-honest validation/leakage-detection work, and grant-funded external-partner research leadership culminating in peer-reviewed publication; measurement- and verification-flavored publications (conference posters/working papers on device/method agreement and comparative model evaluation) alongside peer-reviewed papers; PhD-era methodological-contribution evidence for general research credibility.
- Resume bullets usually compressed or discarded: production-codebase/engineering-heavy bullets, embedded/hardware-implementation detail, and business/entertainment-analytics bullets (WWE) unless page budget is loose, since they read as applied-engineering rather than independent measurement-science research.
- Gaps / do-not-overstate items: do not imply a PhD in statistics, biostatistics, economics, information systems, or clinical informatics (Kevin's PhD is in Physics); do not claim formal causal-inference or quasi-experimental methods training (e.g., RCT design, difference-in-differences, instrumental variables, propensity-score matching) unless Kevin confirms it; do not claim a publication specifically in a top evaluation/measurement-science venue; do not imply having independently designed and led an "AI-as-intervention" causal-impact study with an external health-system partner (Kevin's external-partner research has been observational wearable-sensing studies, not causal intervention evaluation).
- Last updated: 2026-08-26.

### Health, Wearables, Neurotech, And Digital Biomarkers - Archetype JD

- Source JDs used: Oura, Omada, Beacon Biosignals, Lumicity, Motif Neurotech, Dexcom Emerging Sensing Technologies, Dexcom Advanced Sensing Technologies, Senseonics Sr. Algorithm Development Engineer, Atria Health Senior AI Scientist, Cleerly Senior ML Scientist.
...
- Source JDs used: Oden Technologies, Cutsforth, Cargill, RTX / FlightAware, with Lumicity as a regulated-product bridge.
- Archetype role title(s): ML Data Engineer, Senior Data Scientist, Senior Machine Learning Engineer, Data Scientist / Signal Processing Engineer, Algorithm Engineer.
- Typical company / product context: manufacturing AI, industrial process optimization, predictive maintenance, quality/yield/cost prediction, machine failure monitoring, transportation or aviation intelligence, live predictive operational data products, regulated product algorithms, computer vision for production facilities, and operational ML systems that support real decisions.
- Core / necessary matching signals: the JD is centered on operational, industrial, manufacturing, facility, supply-chain, logistics/transportation, reliability, or production-product data; it asks for ML/statistical modeling on time-series, sensor, image/video, process, equipment, event, or contextual data; it emphasizes deployment, monitoring, anomaly/risk detection, forecasting/prediction, diagnostics, optimization, scaling, performance efficiency, or decision support in real operating environments.
- Variable / add-on signals: rotating machinery, electrical/vibration/acoustic diagnostics, computer vision for manufacturing, aviation/transportation ETA prediction, runway/gate/taxi timing forecasts, weather or geospatial datasets, graph neural networks, predictive maintenance, real-time alerting, quality/yield/cost optimization, multi-site rollout, MLOps tooling, Spark/Beam/MLflow/Docker/Airflow/Dagster, Iceberg/Elasticsearch, Kubernetes, observability stacks such as Prometheus/Grafana/Thanos, GPU acceleration, customer-success collaboration, factory-floor/Gemba culture, regulated product lifecycle, or medical-device algorithm validation.
- Typical responsibilities: build data and ML pipelines for high-dimensional heterogeneous time-series, event, image/video, and sensor datasets; develop predictive, forecasting, anomaly, diagnostic, recommendation, or optimization models; process electrical, vibration, acoustic, thermal, image/video, geospatial/weather, and contextual data; improve existing production models and create new product features; deploy and monitor production models; validate in real customer/facility/operational environments; scale POCs to multiple sites or high-volume live products; communicate model value and limits to domain experts.
- Typical requirements: Python scientific and ML stack; PyTorch/TensorFlow/Keras; distributed processing, orchestration, observability, or MLOps tools such as Spark, Beam, MLflow, Docker, Airflow, Dagster, Kubernetes, Prometheus/Grafana, Vertex, SageMaker, or AWS/GCP; signal processing, feature extraction, computer vision, production deployment, stakeholder communication, and comfort with ambiguous, noisy, sparse, high-volume, or drifting operational data.
- Common keywords and phrases: manufacturing, industrial analytics, aviation intelligence, transportation operations, operational forecasting, runway landing time, gate arrival time, taxi duration, ETA prediction, live predictive data, process optimization, predictive maintenance, anomaly detection, real-time alerting, quality, yield, cost, machine failure, sensor data, weather/geospatial data, signal processing, MLOps, deployment, observability, monitoring, drift, performance efficiency, multi-site or high-volume scale.
- Hidden evaluation concerns: direct manufacturing/domain or aviation-operations experience; whether Kevin can turn ambiguous operational data into business value; whether he has production, monitoring, and performance-efficiency judgment; whether validation is practical under drift and limited ground truth; whether he can work with non-ML domain experts; whether infrastructure/tooling terms are supported without overstating deep platform ownership.
...
- Resume bullets usually retained: Podimetrics longitudinal pressure and thermal monitoring, alerting logic, drift/outlier handling, production pipelines, production thermal CV, Next Best Action, A/B testing, quasi-experimental intervention analytics, dashboards/KPIs, customer segmentation/churn, live-event analytics where operational decision support is relevant, CSTR forecasting or geophysical/weather-adjacent signal-processing bullets when physical/geospatial context helps, and compact NASA/JPL for aerospace credibility when page budget allows.
...
- Gaps / do-not-overstate items: do not imply deep manufacturing operations, aviation-operations domain ownership, rotating-machinery fault physics, electrical machine diagnostics, graph neural network production experience, direct weather/geospatial product ownership, expert Kubernetes/observability/orchestration ownership, cloud-platform depth, GPU-acceleration ownership, deep Spark/Iceberg/Elasticsearch platform engineering, or multi-facility rollout ownership unless Kevin confirms.
- Last updated: 2026-08-27.
...
Common signals: quantitative research, research engineering, senior ML engineering on research teams, senior/principal applied scientist roles, scientific AI platforms, production-quality code for research prototypes, data ingestion, feature engineering, validation, quality monitoring, model evaluation, experimentation lifecycle, reproducibility, correctness, maintainability, mathematical maturity, statistics, probability, optimization, linear algebra, numerical computing, imperfect or heterogeneous data, Python, Linux, R, C/C++, distributed computing, model serving, feature stores, experiment management, financial time series, causal analysis, descriptive analysis, construct validity, measurement error, selection bias, data provenance/authority for a research team, GenAI/RAG/agents for scientific workflows, and reusable platform capability.
...
Likely hidden concerns: whether Kevin's PhD field (Physics, not statistics/biostatistics/economics/information systems/clinical informatics) and publication record (applied ML and physical-science venues, not evaluation-science venues) clear the bar this role names explicitly; whether his measurement/verification-adjacent work reads as genuine evaluation-science depth without a formal causal-inference methods background.
...
Common signals: industrial analytics, aviation/transportation intelligence, operational forecasting, live predictive data products, monitoring, anomaly/risk detection, operational decisions, intervention effectiveness, production systems, time-series data, sensor data, image/video or event data, weather/geospatial context, A/B testing, dashboards, reliability, manufacturing, energy, logistics, field data, MLOps, observability, orchestration, and performance efficiency.

Likely hidden concerns: business usefulness, stakeholder-facing decision support, production data quality, validation under drift, ability to convert ambiguous operational data into action, and honest handling of aviation-domain or deep infrastructure gaps.
