...
| Dexcom | Health, Wearables, Neurotech, And Digital Biomarkers | Bayesian / Physical Systems Research | Medium-High | CGM/biosensing algorithm role with strong mechanistic modeling, simulation, feasibility, and performance-limit analysis signals. |
...
|---|---|---|
| Health, Wearables, Neurotech, And Digital Biomarkers | Updated 2026-08-22 | Oura, Omada, Beacon Biosignals, Lumicity, Motif Neurotech, Dexcom. |
...
- Source JDs used: Oura, Omada, Beacon Biosignals, Lumicity, Motif Neurotech, Dexcom.
- Archetype role title(s): Senior ML Data Scientist, Principal Applied ML Scientist, Senior Algorithm/ML Engineer, Staff Algorithm Engineer, Algorithm Engineer, Data and Machine Learning Lead.
- Typical company / product context: wearable health, at-home clinical sensing, continuous glucose monitoring, regulated medical technology, neurotechnology, implantable or wearable therapeutic platforms, emerging biosensing technologies, digital health programs, neuro/biosignal products, longitudinal member or patient data, and algorithms that turn sensor or clinical data into actionable health insight.
...
- Variable / add-on signals: implantable devices, neuromodulation, neurostimulation, mental-health biomarkers, women's health, EEG, CGM, glucose sensing, biophysics, physiology, electrochemistry, analytical chemistry, first-principles models, mechanistic models, digital twins, physics-informed ML, simulation environments, technology readiness, performance-limit analysis, FDA 510(k), IDE/PMA, regulated documentation, causal inference, recommender systems, reinforcement learning, safe/compliant A/B testing, data/ML roadmap ownership, investor/physician communication, AWS/SageMaker, or commercialization leadership.
- Typical responsibilities: build and validate ML, statistical, signal-processing, mechanistic, first-principles, or deep-learning algorithms for longitudinal sensor, experimental, and clinical data; own model lifecycle from requirements and data curation through production monitoring; define data/ML and technology roadmaps; evaluate novel sensing concepts, technical feasibility, readiness, and performance limits; create simulation environments and predictive models to guide investment or development strategy; develop health trajectory, risk, next-best-action, dosing, therapeutic-effect, adherence, relapse-prediction, or biosignal biomarker models; design experiments, data-collection strategies, analytical approaches, and metadata standards; document validation and failure analysis; support regulated product translation; collaborate across science, product, software, hardware, firmware, design, regulatory, clinical, investor/customer, and external-research teams.
- Typical requirements: Python, SQL, MATLAB or similar technical-computing environments, PyTorch or similar ML stack; time-series analysis, signal processing, deep learning, longitudinal modeling, first-principles or mechanistic modeling, simulation, robust validation, health data fluency, study design awareness, data infrastructure, production monitoring, regulated-industry awareness for data-driven medical features, and clear communication of model value, limits, opportunities, and risks.
- Common keywords and phrases: wearable health data, biosignals, digital biomarkers, longitudinal, at-home, CGM, glucose monitoring, biosensing, novel sensing, biophysics, physiology, electrochemistry, analytical chemistry, mechanistic modeling, first-principles modeling, digital twins, simulation frameworks, technology feasibility, technology readiness, performance limits, FDA, 510(k), IDE/PMA, medical device, neurotechnology, neuromodulation, neurostimulation, implantable device, neural electrophysiology, mental health, clinical validation, patient heterogeneity, signal quality, biomarker discovery, dosing, therapeutic effect, adherence, relapse prediction, improvement-native systems, safe/compliant A/B testing, causal inference, recommender systems, reinforcement learning, actionable insights.
- Hidden evaluation concerns: clinical rigor; avoiding overclaims; whether validation survives noisy free-living or experimental data and patient variability; whether Kevin can handle regulated or productized algorithm work; whether he can lead data strategy as well as model development; whether causal/intervention or closed-loop therapy language is supported rather than decorative; whether neurostimulation, psychiatric, implantable-device, CGM, electrochemistry, or analytical-chemistry gaps are acknowledged honestly; whether his adjacent physiological-sensing and physical-modeling background transfers to new biosensing mechanisms.
