...
- Use `project_ids`, `training_ids`, and `award_ids` sparingly. These optional sections should appear only when they improve fit enough to justify space against recent Podimetrics/CVB evidence.
